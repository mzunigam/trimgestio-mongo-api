...
public  class GoogleConfig {
    ...
    private  final String CREDENTIALS_FILE_PATH = "/googleToken.json";
    ...
    public  void toConnect() throws IOException, GeneralSecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
